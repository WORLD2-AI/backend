    ...
    try:
        ...
        try:
            ...
            character_data = {
                ...
                'position': [0, 0],  # 默认位置
                'created_at': character.created_at.strftime('%Y-%m-%d %H:%M:%S') if character.created_at else None,
                'updated_at': character.updated_at.strftime('%Y-%m-%d %H:%M:%S') if character.updated_at else None
            }
