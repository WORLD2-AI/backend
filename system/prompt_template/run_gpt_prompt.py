...
from system.prompt_template.gpt_structure import *
from system.prompt_template.print_prompt import *
...
def run_gpt_prompt_daily_plan(persona,
    ...
    prompt_template = f"./system/prompt_template/v2/daily_planning_v7.txt"
    ...
    logger_info("get daily plan result: ",output)
...
def run_gpt_prompt_generate_hourly_schedule(persona,
    ...
    def create_prompt_input(persona,
        ...
        prompt_ending = f"output what {persona.scratch.get_str_firstname()} will do at {curr_hour_str},output formate should like  ["
        prompt_ending += f" {persona.scratch.get_str_curr_date_str()} -- {curr_hour_str}] Activity:{persona.scratch.get_str_firstname()} is do something"
        if intermission2:
            intermission2 = f"\n{intermission2}"
    ...
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    # prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/generate_hourly_schedule_v2.txt" ########
...
def run_gpt_prompt_task_decomp(persona,
    ...
    def create_prompt_input(persona, task, duration, test_input=None):
        ...
        logger_info (persona.scratch.f_daily_schedule_hourly_org)
        logger_info (all_indices)

        summ_str = f'Today is {persona.scratch.curr_time.strftime("%B %d, %Y")}. '
        summ_str += f'From '
        for index in all_indices:
            logger_info ("index", index)
    ...
    def __func_clean_up(gpt_response:str, prompt=""):
        gpt_response = gpt_response.removeprefix("1)")
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 1000,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v2/task_decomp_v4.txt"
    ...
    logger_info ("run_gpt_prompt_task_decomp result:",output)

    fin_output = []
    time_sum = 0
    for i_task, i_duration in output:
        time_sum += i_duration
        i_task = i_task.removeprefix(persona.scratch.get_str_firstname()+" is")
        i_task = i_task.strip()
...
def run_gpt_prompt_action_sector(action_description,
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 100,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v1/action_location_sector_v1.txt"
...
def run_gpt_prompt_action_arena(action_description,
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 100,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v1/action_location_object_vMar12.txt"
...
def run_gpt_prompt_event_triple(action_description, persona, verbose=False):
    ...
    #              "temperature": 0, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    # prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/generate_event_triple_v1.txt" ########
...
def run_gpt_prompt_act_obj_desc(act_game_object, act_desp, persona, verbose=False):
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 100,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/generate_obj_event_v1.txt" ########
...
def run_gpt_prompt_summarize_conversation(persona, conversation, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 100,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/summarize_conversation_v1.txt" ########
...
def run_gpt_prompt_thought_poignancy(persona, event_description, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 100,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/poignancy_thought_v1.txt" ########
    prompt_input = create_prompt_input(persona, event_description)  ########
    prompt = generate_prompt(prompt_input, prompt_template)
    example_output = "5" ########
    special_instruction = "The output should ONLY contain ONE integer value on the scale of 1 to 10." ########
...
def run_gpt_prompt_chat_poignancy(persona, event_description, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 100,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/poignancy_chat_v1.txt" ########
    prompt_input = create_prompt_input(persona, event_description)  ########
    prompt = generate_prompt(prompt_input, prompt_template)
    example_output = "5" ########
    special_instruction = "The output should ONLY contain ONE integer value on the scale of 1 to 10." ########
...
def run_gpt_prompt_focal_pt(persona, statements, n, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 100,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/generate_focal_pt_v1.txt" ########
...
def run_gpt_prompt_agent_chat_summarize_ideas(persona, target_persona, statements, curr_context, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 100,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/summarize_chat_ideas_v1.txt" ########
...
def run_gpt_prompt_agent_chat_summarize_relationship(persona, target_persona, statements, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 100,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/summarize_chat_relationship_v2.txt" ########
...
def run_gpt_prompt_agent_chat(maze, persona, target_persona,
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 50,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/agent_chat_v1.txt" ########
...
def run_gpt_prompt_summarize_ideas(persona, statements, question, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 50,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/summarize_ideas_v1.txt" ########
...
def run_gpt_prompt_generate_next_convo_line(persona, interlocutor_desc, prev_convo, retrieved_summary, test_input=None, verbose=False):
    ...
    #              "temperature": 0, "top_p": 1, "stream": False,
    #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    # prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/generate_next_convo_line_v1.txt" ########
...
def run_gpt_prompt_memo_on_convo(persona, all_utt, test_input=None, verbose=False):
    ...
    gpt_param = {"engine": "gpt-4o", "max_tokens": 50,
                 "temperature": 0, "top_p": 1, "stream": False,
                 "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
    prompt_template = f"{fs_back_end}/persona/prompt_template/v3_ChatGPT/memo_on_convo_v1.txt" ########
    prompt_input = create_prompt_input(persona, all_utt)  ########
    prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_generate_safety_score(persona, comment, test_input=None, verbose=False):
    ...
    print ("11")
    prompt_template = f"{fs_back_end}/persona/prompt_template/safety/anthromorphosization_v1.txt"
